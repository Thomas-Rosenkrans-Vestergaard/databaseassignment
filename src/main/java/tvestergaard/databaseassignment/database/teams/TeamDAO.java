...
public interface TeamDAO extends DAO
{
    ...
    /**
     * Inserts the provided {@link Team} into the {@link javax.sql.DataSource}. Relations to members of the {@link Team}
     * are also created. Notice that members of the {@link Team} are not created, only their relation to the {@link Team}.
     *
     * @param teamBuilder The {@link TeamBuilder} to model the {@link Team} the insert into the {@link javax.sql.DataSource}.
     ...
     *
     * @param team The {@link Team} to update in the {@link javax.sql.DataSource}.
    ...
    /**
     * Deletes the provided {@link Team} from the provided {@link javax.sql.DataSource}.
     *
     * @param team The {@link TeamReference} to delete from the {@link javax.sql.DataSource}.
